---
title: "Agentic Delivery Framework v0.5.1"
summary: "Normative specification for ADF v0.5.1 including CR-first invariant, SSP algorithm, Capability-Class Routing, CR Gates, Story Preview, Pulse Increment, conformance levels, evidence, metrics, platform profiles, and agent safety rails."
---

# Agentic Delivery Framework (ADF) v0.5.1 Specification

> **Status:** Latest (v0.5.1). v0.5.0 remains normative for teams pinned to the previous minor version.
...
- [2. Sequential Subtask Pipeline (SSP)](#2-sequential-subtask-pipeline-ssp)
  - [Capability-Class Routing (normative)](#capability-class-routing-normative)
...
This specification defines the normative requirements for the Agentic Delivery Framework (ADF) v0.5.1. It applies to delivery teams composed of humans, agents, or hybrid pairs building software or documentation artifacts under governance. Non-normative rationale and implementation guidance live in the [handbook](../handbook/README.md) and associated profiles.

ADF v0.5.1 is backward compatible with v0.5.0. Teams MAY remain on v0.5.0 artifacts while assessing the upgrade. The upgrade path is detailed in the [changelog](../CHANGELOG.md) and [handbook conformance guide](../handbook/conformance.md).
...
### Capability-Class Routing (normative)

ADF defines the following capability classes:
`reasoning`, `debugging`, `code_gen`, `code_refactor`, `code_review`, `vision`, `agent_mode`.

Teams MUST bind outer orchestration and inner SSP phases to capability classes and select models that satisfy those classes.
Routing policies MAY incorporate non-functional traits (e.g., latency, accuracy, premium multipliers, context length) as constraints or tie-breakers.
...
ADF v0.5.1 retains the security posture of v0.4.0 while clarifying Evidence Bundle expectations. The framework:
...
- **v0.5.1:** Adds Capability-Class Routing guidance, including normative SSP binding and routing policy expectations.
